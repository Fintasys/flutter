...
vars = {
  ...
  'dart_revision': 'b3520981e0f04382469f4db72b1c590c6c8e789f',
  ...
  'dart_webdev_rev': '1ea8462431a4fe604e07418ed5d71352e4244b1d',
...
deps = {
  ...
  'engine/src/flutter/third_party/dart/third_party/pkg/dartdoc':
   Var('dart_git') + '/dartdoc.git@95f4208e094a2832dd29a9591d9b95ddf6632174',
     ...
     'packages': [
       {
        ...
        'version': 'fSvuEJgRmHxnewRJr-vT-Wf0-JgR0Wo4UKse5Ufy1pEC'
       }
     ],
